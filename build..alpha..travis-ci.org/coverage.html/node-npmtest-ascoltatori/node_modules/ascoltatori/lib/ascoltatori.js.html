...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-ascoltatori/node_modules/ascoltatori/lib/ascoltatori.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-ascoltatori/node_modules/ascoltatori/lib/ascoltatori.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-ascoltatori/node_modules/ascoltatori/lib/</a> &#187; ascoltatori.js</div>
</div>
<div class="body">
 ...
 */
module.exports.build = <span class="fstat-no" title="function not covered" >function build(opts, done) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  var Klass = null,</span>
    result = null;
&nbsp;
<span class="cstat-no" title="statement not covered" >  Klass = (typeof opts.type === 'function') ? opts.type :</span>
            (classes[opts.type] || module.exports.TrieAscoltatore);
&nbsp;
<span class="cstat-no" title="statement not covered" >  result = new Klass(opts, module.exports);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (opts.prefix) {</span>
<span class="cstat-no" title="statement not covered" >    result = new module.exports.PrefixAscoltatore(opts.prefix, result)</span>
      .once("error", done);
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (opts.json !== false) {</span>
<span class="cstat-no" title="statement not covered" >    result = new module.exports.JSONAscoltatore(result)</span>
      .once("error", done);
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      result.once("ready", <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >        result.removeListener("error", done);</span>
